...
function MsgService() {
  this.init(path.resolve(__dirname, '../db/msg.json'));
}

// inherits from DbObtService
MsgService.prototype = _.create(DbOptService.prototype, {
  constructor: MsgService
});

/**
 * fetch messages with some conditions
